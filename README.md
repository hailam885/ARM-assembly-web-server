...
A basic HTTP web server written in ARM assembly using Apple's AArch64 architecture. This project is built in pure assembly, all kernel functions are replaced with raw syscalls, and certain function without a kernel implementation are implemented in raw Assembly as well.

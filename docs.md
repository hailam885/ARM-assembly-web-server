...
Converts input integer from host's endian to network's endian (in this case a little endian to big endian conversion).
...
Converts an ASCII string into an integer. This does NOT account for integer overflows.
